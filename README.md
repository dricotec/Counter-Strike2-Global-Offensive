...
- **Removed Discontinued Warning**: Since I'll maintain some of this unnofical repo the Discontinued warning isn't needed.
- **Premier Leaderboard that works**: Takes a few of your friends from your friends list and will display them and you in the leaderboard.

# Planned Features
- **BUG fixes**: idk fix whatever bugs I find ig
tuff
