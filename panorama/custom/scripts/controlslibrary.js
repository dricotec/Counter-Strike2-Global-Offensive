...
function OnPopupCustomLayoutCaseConfirm(type) {
    UiToolkitAPI.ShowCustomLayoutPopupParameters('', 'file://{resources}/layout/popups/popup_container_open_confirm.xml', 'case=17293822569102711643&action-type='+type);
}
